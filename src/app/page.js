    ...
    <>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex-1 ml-72 flex flex-col overflow-hidden">
          <div className="bg-white shadow-md sticky top-0 z-10 h-16 flex items-center px-4">
            <input
              type="text"
              placeholder="Search..."
              className="border px-2 py-1 rounded w-64 mr-4"
            />
          ...
          <div className="flex-1 overflow-auto">
            <div className="overflow-x-auto">
              <div className="inline-flex space-x-4">
                <div className="flex gap-6 p-6 min-w-max h-[calc(100vh-80px)]">
